...
public partial class FuncDoor : BaseToggle, Component.IPressable
{
	...
	public static PlayerComponent GetPlayer( object value = default )
	{
		if ( value is GameObject o )
		{
			return o.Components.Get<PlayerComponent>();
		}
