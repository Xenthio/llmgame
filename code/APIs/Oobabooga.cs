...
public class OobaboogaAPI : ILanguageAPI
{
	...
	public string Endpoint = "http://127.0.0.1:7864/v1/chat/completions";
	...
	public async Task<ChatResponse> GenerateChatResponseFromMessages( List<Message> Messages, string replyAs = null )
	{
		...
		var APIMessages = new List<OobaboogaMessage>();
		foreach ( Message m in Messages )
		{
			APIMessages.Add( OobaboogaMessage.ConvertTo( m ) );
		}
...
public class OobaboogaMessage
{
	public string role { get; set; }
	public string content { get; set; }
	public string name { get; set; }
	public static OobaboogaMessage ConvertTo( Message message )
	{
		var b = new OobaboogaMessage()
		{
...
public class OobaboogaChatResponse
{
	...
	public class ChatResponseChoice
	{
		...
		public OobaboogaMessage message { get; set; }
	}
